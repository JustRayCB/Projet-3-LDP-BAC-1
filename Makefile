CXX = g++
CXXFLAGS =  -Wpedantic -Wall -Wextra -Wconversion -Wsign-conversion -Weffc++ \
            ...
            -Wsuggest-final-types -Wsuggest-final-methods -Wsuggest-override -O3 
all: attack decrypt
#-pg -no-pie -fno-builtin
